...
df_success.show(2)
df_missing.show(2)
output_to_parquet(df_success, "s3://ondc-rds-analytics-data-export/temp/pyspark-validations-job/output/validations_done")
output_to_parquet(df_missing, "s3://ondc-rds-analytics-data-export/temp/pyspark-validations-job/output/validations_missing")
